...
namespace DigitsNFCToolkit.Samples
{
	public class ReadScreenView: MonoBehaviour
	{
		...
		private RectTransform iOSReadTransform;
		...
		private void Awake()
		{
			...
			iOSReadTransform = transform.Find("iOSRead").GetComponent<RectTransform>();
		...
		{
#if UNITY_IOS
			tagInfoTransform.gameObject.SetActive(false);
			iOSReadTransform.gameObject.SetActive(true);
#else
			tagInfoTransform.gameObject.SetActive(true);
			iOSReadTransform.gameObject.SetActive(false);
#endif
		}
